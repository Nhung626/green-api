package com.green.repository.common;
...
import static com.green.constants.LabelKey.ERROR_GET_TOTAL_ITEM_FAILED;
import static com.green.utils.DataUtil.*;
import static com.green.utils.DateTimeUtils.safeToDate;
    ...
    private <T> Page<T> queryPage(String sql, Map<String, Object> params, Class<T> classTarget, Pageable pageable) {
        ...
        if (!isNullOrEmpty(listData)) {
            try {
                ...
                throw new AppException(ERROR_GET_TOTAL_ITEM_FAILED);
            }
        }
